...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__breaker_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__board_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__life_bar_js__ = __webpack_require__(7);
...
class Game {
  ...
  runTurn() {
    ...
    let startPos = [this.pointer.pos[0] - 15, this.pointer.pos[1]];
    let interval = 0;
    this.currentAttackers.forEach(breaker => {
      setTimeout(() => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_js__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_view_js__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__monster_js__ = __webpack_require__(6);
  ...
  times(x, pos, newRow) {
    if(x > 0) {
      if(Math.random() > .7) {
        ...
        newRow.push( new __WEBPACK_IMPORTED_MODULE_0__monster_js__["a" /* default */]((100 + this.level * multiplier), Object.assign([],pos), special));
      }
