...
class Monster {
  ...
  collidedBottom(breaker) {
    ...
    if( (this.yRange()[1] < breakPos[1]) && (this.yRange()[1] > breakPos[1] - 10) ) {
            debugger
  ...
  collidedTop(breaker) {
    let breakPos = breaker.pos;
    if( (this.yRange()[0] > breakPos[1] + Util.defaults.breakerSide) && (this.yRange()[0] < breakPos[1] + 10 + Util.defaults.breakerSide ) ) {
            debugger
      let breakerLeft = breakPos[0];
      let breakerRight = breakPos[0] + Util.defaults.breakerSide;
  ...
  collidedRight(breaker) {
    let breakPos = breaker.pos;
    if( (this.xRange()[1] < breakPos[0]) && (this.xRange()[1] > breakPos[0] - 10)) {
      debugger
  ...
  collidedLeft(breaker) {
    let breakPos = breaker.pos;
    if( (this.xRange()[0] > breakPos[0] + Util.defaults.breakerSide) && (this.xRange()[0] < breakPos[0] + 10 + Util.defaults.breakerSide)) {
            debugger
      let breakerTop = breakPos[1];
      let breakerBot = breakPos[1] + Util.defaults.breakerSide;
